...
macro_rules! try_cast_from {
    ($from:ty, $to:ty) => {
        impl crate::cast::TryCastFrom<$from> for $to {
            #[allow(clippy::as_conversions, clippy::float_cmp)]
...
fn test_try_cast_from() {
    let f64_i64_cases = vec![
        ...
        (f64::MAX, None),
        (f64::MIN, None),
        (9_223_372_036_854_775_807_f64, Some(i64::MAX)),
        (-9_223_372_036_854_775_808_f64, Some(i64::MIN)),
        (9_223_372_036_854_775_807_f64 + 10_000f64, None),
        (-9_223_372_036_854_775_808_f64 - 10_000f64, None),
    ];
    let i64_f64_cases = vec![
        (0, Some(0.0)),
        (1, Some(1.0)),
        (-1, Some(-1.0)),
        (i64::MAX, Some(9_223_372_036_854_775_807_f64)),
        (i64::MIN, Some(-9_223_372_036_854_775_808_f64)),
        (i64::MAX - 1, None),
        (i64::MIN + 1, None),
    ];
    let f64_u64_cases = vec![
        ...
        (f64::MIN, None),
        (-1.0, None),
        (18_446_744_073_709_551_615_f64, Some(u64::MAX)),
        (18_446_744_073_709_551_615_f64 + 10_000f64, None),
        // 2^53
        (9_007_199_254_740_992_f64, Some(9_007_199_254_740_992)),
        // 2^53 - 1
        (9_007_199_254_740_991_f64, Some(9_007_199_254_740_991)),
    ];
    let u64_f64_cases = vec![
        (0, Some(0.0)),
        (1, Some(1.0)),
        (u64::MAX, Some(18_446_744_073_709_551_615_f64)),
        (u64::MAX - 1, None),
        // 2^53
        (9_007_199_254_740_992, Some(9_007_199_254_740_992_f64)),
        // 2^53 - 1
        (9_007_199_254_740_991, Some(9_007_199_254_740_991_f64)),
        // 2^53 + 1
        (9_007_199_254_740_993, None),
    ];
